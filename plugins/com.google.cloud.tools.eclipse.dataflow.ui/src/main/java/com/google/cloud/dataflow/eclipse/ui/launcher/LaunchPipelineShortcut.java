...
public class LaunchPipelineShortcut implements ILaunchShortcut2 {
  ...
  /**
   * A resource this shortcut is capable of launching. If the resource is a Java class file that
   * contains a main method, contains a handle to that method and the primary type.
   */
  private static class LaunchableResource {
    ...
    public LaunchableResource(IResource resource, IMethod mainMethod, IType primaryType) {
      ...
      if (mainMethod == null && primaryType != null) {
        throw new NullPointerException(
            "mainMethod and primaryType must either both be null or neither can be null");
      }
      if (mainMethod != null && primaryType == null) {
        throw new NullPointerException(
            "mainMethod and primaryType must either both be null or neither can be null");
    ...
    public String getLaunchName() {
      if (mainMethod != null && mainMethod.exists()) {
        return String
            .format("%s_%s", getProjectName(), primaryType.getElementName());
      } else {
